...
begin
  ...
  Should(TEncoding.UTF8.GetString(AV2.Payload)).Be(
    TEncoding.UTF8.GetString(AV1.Payload));
...
begin
  ...
  try
    AppendText(V1, V2,
      'MSG a 1 1'#13#10'x'#13#10 +
      'MSG b 2 2'#13#10'yz'#13#10 +
      'PING'#13#10 +
...
begin
  ...
  try
    ...
    Wire := 'HMSG foo 9 ' + RawByteString(IntToStr(Length(Header))) + ' ' +
      RawByteString(IntToStr(Length(Header) + 4)) + #13#10 +
      Header + 'data'#13#10;
